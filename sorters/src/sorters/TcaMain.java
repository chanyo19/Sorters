...
public class TcaMain {
	...
	public static void main(String[] args) {
	    ...
	    final ActorRef listener = system.actorOf(Props.create(Listener.class), "listener");// create the result listener, which will print the result and shutdown the system
	 

	    ActorRef master = system.actorOf(Props.create(Master.class, 50, listener), "master"); // create the master
	 
	  
	    master.tell(new BubbleSortIn(data1), ActorRef.noSender());  // start the calculation
